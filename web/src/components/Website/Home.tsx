import imgMulherNegra from '../../assets/mulher-negra-com-moleton-verde-com-as-duas-maos-no-peito.png';
  ...
  return (
    <section id="home">
      <div className="wrapper">
        ...
        <div className="stats">
          <div className="stat">
            <h3 className="animate-number">3500</h3>
            <p>Pacientes atendidos</p>
          </div>

          <div className="stat">
            <h3 className="animate-number">35</h3>
            <p>Especialistas disponíveis</p>
          </div>

          <div className="stat">
            <h3 className="animate-number">20</h3>
            <p>Anos no mercado</p>
          </div>
        </div>
      </div>

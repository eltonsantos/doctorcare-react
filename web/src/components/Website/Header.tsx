...
export function Header() {
  ...
  const { toggleNavbar, setIsNavbarOpen, isNavbarOpen } = useContext(navbarContext) as INavbarContext;
  ...
  return (
    <header id={(isScroll && !isNavbarOpen) ? 'scroll-header' : ''}>
      <nav id="navigation">
        <div className="wrapper">
          ...
          <div className="menu">
            <ul>
              <li><a onClick={() => setIsNavbarOpen(false)} href="#home">Início</a></li>
              <li><a onClick={() => setIsNavbarOpen(false)} href="#services">Serviços</a></li>
              <li><a onClick={() => setIsNavbarOpen(false)} href="#about">Sobre</a></li>
            </ul>

            <a className="button" onClick={() => setIsNavbarOpen(false)} href="#contact"
              >Agende sua consulta</a
            >

            <ul className="social-links">
              <li>
                <a target="_blank" href="https://instagram.com/eltin182"
                  ><svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a target="_blank" href="https://facebook.com/eltin182">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a target="_blank" href="https://youtube.com/c/eltonsantos_oficial">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
